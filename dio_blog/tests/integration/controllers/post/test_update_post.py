...
async def test_update_post_sucess(client: AsyncClient, access_token: str):
  #Given | O que eu quero
  headers = {"Authorization": f"Bearer {access_token}"}
  data = {
    "title": "Update post 1",
    "content": "Conteudo update 1",
    "published": False
  }
  post_id = 1
...
async def test_update_post_title_fail(client: AsyncClient, access_token: str):
  #Given | O que eu quero
  headers = {"Authorization": f"Bearer {access_token}"}
  data = {
    "title": "Post 2",
